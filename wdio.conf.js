const utilities= require('./test/util/utilities');
...
const baseURL = process.env.BASE_URL || 'http://demowebshop.tricentis.com/';
...
exports.config = {
    ...
    beforeTest: function (test, context) {
        ...
        allure.addEnvironment("BROWSER_VERSION", "98.0.4758.109");
        allure.addEnvironment("PLATFORM", "WINDOWS 10");
        allure.startStep("Open Web Shop");
        browser.url('');
        allure.endStep();
